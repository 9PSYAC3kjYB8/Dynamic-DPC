...
int main() {
    ...
    while (1) {
        ...
        if (flag) {
            ...
            update_local_density_insertion(dataset_active, &dataset[idx_insertion]);
            ...
            update_dependent_point(dataset_active);
        ...
        if (idx_insertion == dataset.size() - 1 || counter == 2000001) {
        ...
        double hour = std::chrono::duration_cast<std::chrono::hours>(end - init).count();
        //if (hour >= 24) break;
    }
